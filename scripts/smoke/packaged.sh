...
#
# Runs the three offline scenarios that prove the SHIPPED pkg binary works end to end
...
#   Default scenario set: storage mcp ask-core.
set -euo pipefail
...
if [ "${#SCENARIOS[@]}" -eq 0 ]; then
  SCENARIOS=(storage mcp ask-core)
fi
